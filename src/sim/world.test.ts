...
test('a crate dropped from 2 m rests at y = 0.50 ± 0.01 within 120 steps', () => {
  ...
  prototypeRoom.crates.forEach((p, i) => receive(sim, { type: 'spawn', from: 'H', id: `H:${i}`, kind: 'prop', home: null, p }));
  // Its bottom face starts 2 m above the floor.
  receive(sim, { type: 'spawn', from: 'H', id: 'H:10', kind: 'prop', home: null, p: { x: 0, y: 2.5, z: 0 } });
