...
`gamestudio/` is copied whole and knows nothing about the engine. Everything that depends on the stack lives in two project files, not here.
...
3. **The spend rate of the providers' windows**: it depends on the size of the code and the length of the cycle.
